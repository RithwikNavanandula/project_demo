...
class Model: 
    ...
    def setupRNN(self):
        ...
        numHidden = 256
        lstm1 = Bidirectional(
            LSTM(numHidden, return_sequences=True, name='lstm_8'),
            name='bidirectional_8'
        )
        lstm2 = Bidirectional(
            LSTM(numHidden, return_sequences=True, name='lstm_9'),
            name='bidirectional_9'
        )
        ...
        dense = Dense(len(self.charList) + 1, name='dense_4')
    ...
    def save(self, epoch):
        "save model to file"
        self.snapID += 1
        self.saver.save(self.sess, 'model_greek_word/snapshot', global_step=epoch)
